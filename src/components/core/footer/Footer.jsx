		...
		<>
			<footer className="footer-wrapper">
				<div className="footer-wrapper-inner">
					<div className="about">
						<figure>
							<img src="https://en.artsdot.com/ADC/Art.nsf/ArtsDot-Footer-Payment-Guaranteed.png" width={75} height={58} />
						</figure>
						<p><span>Our Warranty </span>If you are not 100% satisfied we will refund you 100% of your order.</p>
						<ul>
							<li>
								<a href="#">
									<img src="https://en.artsdot.com/ADC/Art.nsf/ArtsDot-Footer-Payment-1.png" alt="icons" width={36} height={22} />
								</a>
							</li>
							<li>
								<a href="#">
					...
					<div className="detail">
						<h2>ADDRESS</h2>
						<ul>
							<li><span></span>hello@rameo.website</li>
							<li><span></span>(02) 6441 6721</li>
							<li><span></span>12/56 Grand Avenue, Sydney, Australia</li>
						</ul>
					</div>
				</div>
